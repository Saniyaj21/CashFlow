...
- smartTips: 3-5 practical, specific tips based on Indian financial practices and amounts
...
Be specific to the data provided. If limited data, acknowledge this and provide general guidance appropriate for Indian users.
`;
};
...
export const generateFinancialInsights = async (financialData) => {
  try {
    ...
    try {
      ...
      const requiredFields = ['healthScore', 'spendingAnalysis', 'savingsInsights', 'budgetRecommendations', 'smartTips', 'trendAnalysis', 'riskAssessment', 'priorityActions'];
